...
export function Hero() {
  ...
  return (
    <section id="hero" aria-label="Hero" ref={containerRef} className="relative w-full min-h-screen flex flex-col items-center justify-center pt-24 pb-12 md:pb-20 px-6 overflow-visible">
      {/* Radial glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-[radial-gradient(circle,hsla(var(--accent-raw)/0.07)_0%,hsla(var(--accent-raw)/0.03)_30%,transparent_60%)] pointer-events-none" />
